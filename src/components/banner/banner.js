    ...
    <div className='flex flex-col-reverse gap-10 md:flex-row md:justify-between w-full'>
        <div className='flex flex-col w-full md:w-2/3 justify-center items-center'>
            <div className='flex flex-col '>
                <h1 className='text-3xl md:text-6xl text-gray-900 font-bold mb-6 md:mb-12'>Rent a <span className="text-pink-600">Place</span> away from <span className="text-pink-600">Home</span> in the <span className="text-pink-600">Metaverse</span></h1>
                <p className='mb-12  text-lg md:text-2xl'>We provide you access to luxury and affordable houses in the netaverse, get a chance to turn your imagination to reality at your comfort zone</p>
                <form className=''>
